...
val myList = mutableStateListOf(
    Data(
        ...
        id = 0,
        obj = "https://res.cloudinary.com/dvzraa0b0/image/upload/v1753719092/BASEmodel1_mzogls.glb"
    ),
    Data(
        name = "Push-Up",
        publisher = "Easy",
        ...
        id = 1,
        obj = "https://res.cloudinary.com/dvzraa0b0/image/upload/v1753719092/BASEmodel_pushup_fn7zlm.glb"
    ),
    Data(
        name = "Squads",
        publisher = "Easy",
    ...
    Data(
        ...
        id = 3,
        obj = "https://res.cloudinary.com/dvzraa0b0/image/upload/v1753719092/BASEmodel_squad_qjvh59.glb"
    )
)

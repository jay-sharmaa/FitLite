...
@Composable
fun MyNav(homePageViewModel: HomePageViewModel, context : Context, authViewModel: PersonViewModel, tts: TextToSpeech, pipModeState: MutableState<Boolean>){
    ...
    NavHost(navController = navController, startDestination = startDestination) {
        ...
        composable("mainScreen/{userName}") {
            ...
            if (userName != null) {
                MainScreen(homePageViewModel = homePageViewModel, context = context, authViewModel = authViewModel, userName = userName, tts = tts, pipModeState = pipModeState)
            }
        }
    }
}
